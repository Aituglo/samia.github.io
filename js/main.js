...
M.AutoInit = function (context) {
  ...
  var registry = {
    ...
    TapTarget: root.querySelectorAll('.tap-target1:not(.no-autoinit)'),
...
;(function ($) {
  ...
  var TapTarget = function (_Component19) {
    ...
    _createClass(TapTarget, [{
      ...
      key: "_handleDocumentClick",
      value: function _handleDocumentClick(e) {
        if (!$(e.target).closest('.tap-target1-wrapper').length) {
          this.close();
          e.preventDefault();
          e.stopPropagation();
        }
      ...
      value: function _setup() {
        ...
        this.waveEl = $(this.wrapper).find('.tap-target1-wave')[0];
        this.originEl = $(this.wrapper).find('.tap-target1-origin')[0];
        this.contentEl = this.$el.find('.tap-target1-content')[0];

        // Creating wrapper
        if (!$(this.wrapper).hasClass('.tap-target1-wrapper')) {
          this.wrapper = document.createElement('div');
          this.wrapper.classList.add('tap-target1-wrapper');
        ...
        if (!this.contentEl) {
          ...
          this.contentEl.classList.add('tap-target1-content');
        ...
        if (!this.waveEl) {
          ...
          this.waveEl.classList.add('tap-target1-wave');

          // Creating origin
          if (!this.originEl) {
            this.originEl = this.$origin.clone(true, true);
            this.originEl.addClass('tap-target1-origin');
